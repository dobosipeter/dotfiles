    ...
    {"lewis6991/gitsigns.nvim"},
{
  ...
  opts = {
    ...
    config = function ()
        ...
        -- Load from external file (in config/headers dir)
        local header_path = vim.fn.stdpath('config') .. '/headers/run.txt'
...
'░▒▓█▓▒░░▒▓█▓▒░  ░▒▓██▓▒░  ░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░░▒▓█▓▒░',                       
        ...
        local quote_path = vim.fn.stdpath('config') .. '/quotes/dijkstra.txt'
        local footer = {}
...
-- :q or Ctrl-d to close when the shell ends
